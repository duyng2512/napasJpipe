package com.openwaygroup.pipe.napasincomingfindebit;
...
public class Mapper extends com.openwaygroup.pipe.napasincomingfindebit.autogen.Mapper {
		...
		public void processRow() throws Exception {
			if(!incomingFinDebit.dataNotFound()){
				try{
					docFileXml.addStartElement("Doc");
						...
						docFileXml.addStartElement("DocRefSet");
							docFileXml.addStartElement("Parm");
								...
								docFileXml.addElement("Value",incomingFinDebit.getAuthorizationnumber());
							docFileXml.addFinishElement("Parm");
						docFileXml.addFinishElement("DocRefSet");
						
						docFileXml.addElement("LocalDt", incomingFinDebit.getLocaltransactiondate());
						docFileXml.addElement("Description",DESCRIPTION);
						
						docFileXml.addStartElement("SourceDtls");
							docFileXml.addElement("SIC",incomingFinDebit.getSiccode());
						docFileXml.addFinishElement("SourceDtls");
						
						docFileXml.addStartElement("Requestor");
							docFileXml.addElement("ContractNumber",incomingFinDebit.getCardNumber());
						...
						docFileXml.addStartElement("Source");
							docFileXml.addElement("ContractNumber",incomingFinDebit.getTerminalidentification());
							docFileXml.addElement("TransitId",incomingFinDebit.getAcquiringinstitutioncode());
							docFileXml.addStartElement("Product");
						...
						docFileXml.addStartElement("Transaction");
							docFileXml.addStartElement("Currency");
								docFileXml.add(incomingFinDebit.getTransactioncurrencycode().equals("000") ? "704" : incomingFinDebit.getTransactioncurrencycode());
							docFileXml.addFinishElement("Currency");
							
							docFileXml.addElement("Amount",String.valueOf(incomingFinDebit.getTransamount()));
							...
							docFileXml.addStartElement("Extra");
								...
								//logging Additional data
									docFileXml.addStartElement("Parm");
										...
										docFileXml.addElement("Value",incomingFinDebit.getProcessingcode());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","SystemTraceNumber");
										docFileXml.addElement("Value",incomingFinDebit.getSystemtracenumber());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","F15");
										docFileXml.addElement("Value",incomingFinDebit.getSettlementdate());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","AcquiringInstitutionCode");
										docFileXml.addElement("Value",incomingFinDebit.getAcquiringinstitutioncode());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","SMLRespCode");
										docFileXml.addElement("Value",incomingFinDebit.getReturnCode().toString());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","FromAccount");
										docFileXml.addElement("Value",incomingFinDebit.getFromaccount());
									docFileXml.addFinishElement("Parm");
									
									docFileXml.addStartElement("Parm");
										docFileXml.addElement("ParmCode","ToAccount");
										docFileXml.addElement("Value",incomingFinDebit.getToaccount());
									docFileXml.addFinishElement("Parm");
						...
						docFileXml.addStartElement("Billing");
							docFileXml.addElement("Currency",incomingFinDebit.getTransactioncurrencycode().equals("000") ? "704" : incomingFinDebit.getTransactioncurrencycode());
							docFileXml.addElement("Amount", String.valueOf(incomingFinDebit.getTransamount()));
						...
						docFileXml.addStartElement("Status");
							docFileXml.addElement("RespClass",incomingFinDebit.getReturnCode() == 0 ? "Information" : "Error");
							docFileXml.addElement("RespCode",incomingFinDebit.getReturnCode().toString());
					...
					processMessage("incomingFinDebit is null. Stop");
				}
			}
		}
	}
	...
	*/
	...
	private void createXmlHeaderFile() throws Exception{
		...
		docFileXml.getFileParameters().setFileName(strCurrentDate1 + "_" + "NAPAS_INCOMING_DEBIT" + "_" + fileNumber + ".xml");
	...
	protected String checkIS_AUTHORIZATION(){
		...
		for(String[] temp : MessageCodeMapping){
			...
			if(temp[2].equals(incomingFinDebit.getSiccode())){
				//this means ATM Transaction
				if(temp[3].replace("xx", incomingFinDebit.getProcessingcode().substring(2, 4))
							.equals(incomingFinDebit.getProcessingcode()))
				{
		...
		try {
			skipFile("Transaction ID Not Found![STAN]:"+incomingFinDebit.getSystemtracenumber()+"[AUTHCODE]:"+incomingFinDebit.getAuthorizationnumber()+ "[ProcessingCode]:"+incomingFinDebit.getProcessingcode()+"[SIC]:"+incomingFinDebit.getSiccode());
	...
	protected void processMessage(String type, String msg, boolean isMsgBox,
		...
		msg = "[Napas Incoming Fin Debit]:"+msg;
		...
		if (isMsgBox) {
			pipe.showMessageDialog(new ShowDialogParameters(
					"Napas Incoming Fin Debit", msg, boxType));
		}
	}
