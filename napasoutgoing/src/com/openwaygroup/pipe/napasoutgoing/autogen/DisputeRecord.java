...
public class DisputeRecord extends SelectSourceVectorBuffer
{
    ...
    private   java.lang.Long settlementamount;
    
    public java.lang.Long getSettlementamount() {
      return settlementamount;
    }
    
      public void setSettlementamount(java.lang.Long settlementamount) {
  ...
  private static final VectorMetaData VECTOR_META_DATA =
      new VectorMetaData(DisputeRecord.class, new VectorFieldMetaData[] {
         idMetaData,
         cardNumberMetaData,
  ...
  protected void retrieveBuffer() throws Exception {
    id =  getLong(idMetaData);
            ...
            transamount =  getString(transamountMetaData);
            ...
            messagetypeidentifiercode =  getString(messagetypeidentifiercodeMetaData);
            transactionstatus =  getString(transactionstatusMetaData);
            ...
            settlementamount =  getLong(settlementamountMetaData);
