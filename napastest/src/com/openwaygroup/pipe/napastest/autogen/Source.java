...
public class Source extends FlatFileSourceBuffer {
  ...
  FlatFileBufferFieldString Direction;
  ...
  public String getDirection() {return Direction.getValue();}
  ...
  public void setDirection(String val) {Direction.setValue(val);}
  ...
  public Source() {
    ...
    Direction = new FlatFileBufferFieldString("Direction");
  ...
  initStandardVariables();
    records[0].fields = new FlatFileBufferField.RecordAdapter[4];
    records[0].fields[0] = new FlatFileBufferField.RecordAdapter(FileGeneratingDate,null,null);
    records[0].fields[1] = new FlatFileBufferField.RecordAdapter(ServiceCode,null,null);
    records[0].fields[2] = new FlatFileBufferField.RecordAdapter(Direction,null,null);
    records[0].fields[3] = new FlatFileBufferField.RecordAdapter(MemberBankCode,null,null);
    records[0].nOfFields = 4;
